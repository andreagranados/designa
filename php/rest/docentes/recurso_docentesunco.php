...
/**
 * @description Operaciones sobre Docentes
 */
class recurso_docentesunco implements SIUToba\rest\lib\modelable //esta interface es documentativa, puede no estar
{
	...
	function get_list()
	{
		...
		$docentes = modelo_docente::get_docentes($where, $order_by, $limit);
