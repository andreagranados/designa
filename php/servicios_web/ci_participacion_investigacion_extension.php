...
{	
	function ini()
	{
            ...
            $sql="select * from (select 'I' as tipo,i.denominacion,rescd as norma,doc.nro_docum,f.descripcion as funcion,pi.carga_horaria,pi.desde,pi.hasta "
                    ...
                    . " UNION "
                    ."select 'I' as tipo,i.denominacion,rescd as norma,p.nro_docum,f.descripcion as funcion,pi.carga_horaria,pi.desde,pi.hasta "
