...
class dt_asignacion_tutoria extends toba_datos_tabla
{
        ...
        function get_asignaciones()
	{
       ...
       function get_listado_desig($des){
        $sql = "SELECT t_a.id_designacion,t_a.id_tutoria,t_u.descripcion,t_a.carga_horaria,t_m.descripcion as desc_materia,t_t.desc_item as rol,t_p.descripcion as periodo,t_a.anio"
