        ...
        function get_listado_con_legajo($filtro=array()){
            ...
            if(count($documentos)>0){
                ...
                if(count($datos_mapuche)>0){ 
                    ...
                    $sql = "SELECT a.*,b.nro_legaj,cast (position('Í' in b.desc_nombr),text) as b.desc_appat,translate(convert_from(convert_to(b.desc_nombr,'UTF8'), 'UTF8'),'áéíóúÁÉÍÓÚäëïöüÄËÏÖÜ','aeiouAEIOUaeiouAEIOU') as desc_nombr,b.tipo_doc,b.nro_doc,b.nro_cuil3,b.nro_cuil4,b.nro_cuil5,b.sexo,b.nacim,b.fec_ingreso,b.telefono_celular,b.telefono,b.correo_electronico,a.nro_cuil1||'-'||a.nro_cuil||'-'||a.nro_cuil2 as cuil, b.nro_cuil3||'-'||b.nro_cuil4||'-'||b.nro_cuil5 as cuilm from ("
