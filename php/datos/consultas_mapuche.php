...
class consultas_mapuche
{
 ...
 function get_lic_maternidad($ua,$udia,$pdia){
 	...
 	$sql="select distinct b.nro_licencia,case when b.nro_legaj is null then a.nro_legaj else b.nro_legaj end as nro_legaj,b.nro_cargo,fec_desde,fec_hasta,codn_tipo_lic as tipo_lic
		...
		and (c.codn_tipo_lic='MATE' or c.codn_tipo_lic='MAT2' or c.codn_tipo_lic='MAT3' or c.codn_tipo_lic='MAT4' or c.codn_tipo_lic='MD90')
 ...
 function get_cargos($ua,$udia,$pdia){
	...
	$sql=" select distinct a.*  from (select b.nro_cargo,b.chkstopliq,b.codc_uacad,b.codc_categ,b.codc_carac,b.fec_alta,b.fec_baja,b.nro_legaj,a.desc_appat,a.desc_nombr,tipo_ejercicio||'.'||to_char(codn_grupo_presup,'0000')||'-'||to_char(codn_area ,'000')||'-'||to_char(codn_subar,'000')||'-'||to_char(codn_subsubar,'000')||'-'||to_char(codn_fuent,'00')||'-'||to_char(codn_progr,'00')||'-'||to_char(codn_subpr,'00')||'-'||to_char(codn_proye,'00')||'-'||to_char(codn_activ,'00')||'-'||to_char(codn_obra,'00')||'-'||codn_final||'-'||codn_funci as imputacion,codn_area,codn_subar,codn_subsubar,codn_fuent,porc_ipres
 	 from mapuche.dh03 b
