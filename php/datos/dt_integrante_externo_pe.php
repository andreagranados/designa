...
class dt_integrante_externo_pe extends designa_datos_tabla
{
    ...
    {
        $sql="select id_pext,apellido||', '||nombre as nombre,tipo_docum,nro_docum,fec_nacim,tipo_sexo,pais_nacim,funcion_p,carga_horaria,desde,hasta,rescd from integrante_externo_pe where id_pext=".$id_p;
