...
class dt_suplente extends toba_datos_tabla
{
    ...
    function get_suplencias($filtro=null){
        ...
        $sql="select * from (select distinct d.uni_acad,d.id_designacion,doc2.apellido||', '||doc2.nombre as agente1, doc2.legajo as legajo1,d.carac as caracs,d.desde as desde_s,d.hasta as hasta_s,d.cat_estat||d.dedic as categoria_s,doc.apellido||', '||doc.nombre as agente2,s.id_desig,doc.legajo,e.cat_estat||e.dedic as categoria,e.desde,e.hasta,e.carac,t.desc_corta as novedad,n.desde as desden,n.hasta as hastan
                from suplente s
