...
class dt_integrante_externo_pi extends toba_datos_tabla
{
    ...
    function get_plantilla($id_p){
        ...
        $sql="(select upper(trim(t_do.apellido)||', '||trim(t_do.nombre)) as nombre,t_do.tipo_docum,t_do.nro_docum,t_do.tipo_sexo,t_d.cat_estat||'-'||t_d.dedic as categoria,t_i.ua,t_i.carga_horaria,t_f.descripcion as funcion_p"
                ...
                ." UNION"
                . " (select upper(trim(t_p.apellido)||', '||trim(t_p.nombre)) as nombre,t_e.tipo_docum,t_e.nro_docum,t_p.tipo_sexo,'' as categoria,t_p.institucion as ua,t_e.carga_horaria,t_f.descripcion as funcion_p"
