           ...
           // print_r($datos_novedad);exit;
            if (isset($this->s__listado)){
                ...
                foreach ($this->s__listado as $des) {
                        $datos[$i]=array('col2' => $des['agente'], 'col3' => trim($des['legajo']) ,'col4' => $des['id_designacion'],'col5' => $des['mat0'],'col6' => $des['mat1'],'col7' => $des['mat2'],'col8' => $des['mat3'],'col10' => $des['mat4'],'col11' => $des['mat5'],'col12' => $des['investig'],'col13' => $des['extens'],'col14' => $des['postgrado'],'col15' => $des['tutorias'],'col16' => $des['otros']);
                        $i++;  
                    }
                
               //genera la tabla de datos
               
                $pdf->ezTable($datos, array( 'col2'=>'<b>Agente</b>','col3' => '<b>Legajo</b>','col4' => '<b>IDDesig</b>','col5' => '<b>M1</b>','col6' => '<b>M2</b>','col7' => '<b>M3</b>','col8' => '<b>M4</b>','col10' =>'<b>M5</b>','col11' => '<b>M6</b>','col12' => '<b>I</b>','col13' => '<b>E</b>','col14' => '<b>P</b>','col15' => '<b>T</b>','col16' => '<b>O</b>'), $titulo, $opciones);
