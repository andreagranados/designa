------------------------------------------------------------
--[203]--  Ver Proyectos Investigación 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'203', --molde
	'10', --operacion_tipo
	'Ver Proyectos Investigación', --nombre
	'3738', --item
	'ver_proyectos_investigacion', --carpeta_archivos
	'_ver_proyectos_investigacion', --prefijo_clases
	'designa', --fuente
	'23'  --punto_montaje
);
